...
module.exports = {
  ...
  // cacheDirectory: "C:\\Users\\rzrshrp\\AppData\\Local\\Temp\\jest",
  ...
  moduleNameMapper: {
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga|ppsx)$':
  ...
  transformIgnorePatterns: ['/node_modules/(?!(firebase|@firebase)).+\\.js$']
