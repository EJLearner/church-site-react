...
class Quote extends Component {
  getQuote() {
    const quotes = [
      ...
      '“Give instruction to a wise man, and he will be still wiser; teach a righteous man, and he will increase ' +
        'in learning.” Proverbs 9:9',

      '“Everyone who goes on ahead and does not abide in the teaching of Christ, does not have God. Whoever abides ' +
        'in the teaching has both the Father and the Son.” 2 John 1:9',
      ...
      '“And these words that I command you today shall be on your heart. You shall teach them diligently to your ' +
        'children, and shall talk of them when you sit in your house, and when you walk by the way, and when you ' +
      ...
      '“Things that we have heard and known, that our fathers have told us. We will not hide them from their ' +
        ...
        'that he has done. He established a testimony in Jacob and appointed a law in Israel, which he ' +
        'commanded our fathers to teach to their children, that the next generation might know them, the children ' +
        'yet unborn, and arise and tell them to their children, so that they should set their hope in God and not ' +
        'forget the works of God, but keep his commandments...” Psalm 78: 3-8',
