export default {
  ...
  '2024-04-07': {
    ...
    content: (
      <p>
        ...
        mercenary because he wants to read it, nor his love for poetry mercenary
        because he wants to read it, nor his love of exercise less disinterested
  ...
  '2024-04-28': {
    ...
    content: (
      <p>
        ...
        we are to love and care for the poor and hungry, too. “You will know
        them by their fruits” (Matt. 7:16a – RSV) he said, and he meant that we
        are known by our etherical behavior as illustrated by life experience.”
      </p>
    ),
  },
  '2024-05-05': {
    ...
    content: (
      <p>
        ...
        salvation is the story of the God who comes. It is always he who comes,
        even if he has not yet come in his fullness. But there is indeed one
        unique moment in his coming; the others were only preparations and
        announcement. The hour of his coming is the Incarnation. The Incarnation
        brings the world his presence. It is a presence so complete that it
        overshadows every presence before it. God is made human in Christ. God
        makes himself present to us with such a special presence, such an
        obvious presence, as to overthrow all the complicated calculations made
        about him in the past. “The invisible, intangible God has made himself
        visible and tangible in Christ.” If Jesus is truly God, everything is
        clear; if I cannot believe this, everything darkens again.”
      </p>
    ),
  },
  '2024-05-12': {
  ...
  '2024-05-19': {
    ...
    content: (
      <p>
        ...
        desires, and by infatuation with materials things. If this spirit is
  ...
  '2024-09-29': {
    ...
    content: (
      <p>
        ...
        trial of my faith. In a moment like this I know that thou couldst have
        worked thy good in me with so little strain, with so little effort. And
        then to thee would have been given the praise and glory. When I neglect
        to pray, mine is the loss. Forgive me, Lord. Amen.”
      </p>
    ),
  },
  '2024-10-13': {
  ...
  '2024-10-27': {
    subTitle: (
      <>
        From <i>Living Prayer</i> by Anthony Bloom
      </>
    ),
    content: (
      <p>
  ...
  '2025-02-09': {
    subTitle: (
      <>
        From <i>Free to Pray, Free to Love</i> by Max Oliva, S.J.
      </>
    ),
    content: (
      <p>
  ...
  '2025-05-25': {
    ...
    content: (
      <p>
        ...
        the ones who come with the minds and heart of a child. It’s the same
  ...
  '2026-01-04': {
    ...
    content: (
      <p>
        “To view reality from a slightly different perspective often yields a
        view of things totally unlike what they appeared to be. If we take just
        a couple of steps in another direction, what we view as reality is often
        profoundly changed.”
      </p>
    ),
  },
  ...
  '2026-02-22': {
    ...
    content: (
      <p>
        “Goodness and Faithfulness – we think of them as the supreme virtues of
        plain people. Yet they, too, are the fruits of the Spirit. In the long
        run we cannot really manage them without God. The good citizens, good
        employer, good artist, good worker – the faithful husband or wife or
        mother – in these, too, Divine Love, selfless charity, is bringing forth
        its fruits within the natural order and on the natural scale:
        proclaiming the dignity and possibilities of our human life on all
