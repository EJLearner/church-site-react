...
export default {
  ...
  '2020-05-31': {
    subTitle: (
      <>
        From <i>The Church of the Spirit</i>
      </>
    ),
    content: (
      <p>
        ...
        God and our neighbor – this, indeed, is the essence of the spiritual
  ...
  '2020-07-05': {
    ...
    content: (
      <p>
        ...
        forming was the primacy of faith instead of structures. What made us one
        was Christ, and the imitation of him gave meaning to the manner of
        living of each one of us. There was the whole expressions around us of
        the life of a simple Christian.”
      </p>
    )
  },
  '2020-07-12': {
  ...
  '2020-11-15': {
    subTitle: (
      <>
        From <i>Tensions</i> by H. A. Williams
      </>
    ),
    content: (
      <p>
    ...
    content: (
      <>
        <p>
          ...
          purpose of prayer: to glorify the name of God.
        </p>
        <p>
          The scales fell from my eyes. I saw in a new light the misuse of
          prayer and the difficulties connected with prayer as well as the place
          of our own efforts in prayer.
        </p>
        <p>
          Prayer life has its own laws, as all the rest of life has. The
          fundamental law in prayer is this: Prayer is given and ordained for
          the purpose of glorifying God. Prayer is the appointed way of giving
          Jesus an opportunity to exercise his supernatural powers of salvation.
          And in so doing he desires to make use of us.”
        </p>
      </>
    )
  },
    ...
    content: (
      <>
        <p>
          ...
          the Blessed Sacrament is the visible sign or my covenant with him.
        </p>
        <p>
          That is why I believe in personal prayer, and why every day I wait to
          meet him in the Eucharist. To pray means to wait for the God who
          comes.
        </p>
        <p>
          Every prayer-filled day sees a meeting with the God who comes; every
          night which we faithfully put at his disposal is full of his presence.
        </p>
        <p>
          And his coming and his presence are not only the result of our waiting
          or a prize for our efforts: they are his decision, based on his love
          freely poured out.
        </p>
        <p>
          His coming is bound to his promise, not to our works or virtue. We
          have not earned the meeting with God because we have served him
          faithfully in our brethren, or because we have heaped up such a pile
          of virtue as to shine before Heaven.
        </p>
        <p>
          God is thrust onward by his love, not attracted by our beauty. He
          comes even in moments when we have done everything wrong, when we have
          done nothing…when we have sinned.”
        </p>
      </>
    )
  },
    ...
    content: (
      <>
        <p>
          ...
          salvation is the story of God who comes.
        </p>
        <p>
          It is always he who comes, even if he has not yet come in his
          fullness. But there is indeed one unique moment in his coming; the
  ...
  '2020-12-27': {
    ...
    content: (
      <>
        <p>
          “The love of our neighbor is the love that comes down from God to man.
          ...
          thought it were the last, the most miserable, the most deformed of
          souls, God will precipitate himself into it in order, through it, to
          look at and listen to the afflicted. Only as time passes does the soul
          become aware that he is there. But, though it finds no name for him,
          wherever the afflicted are loved, for themselves alone, it is God who
          is present.
        </p>
        <p>
          God is not present, even if we invoke him, where the afflicted are
          merely regarded as an occasion for doing good. They may even be loved
          on this account, but then they are in their natural role, the role of
          matter and of things. We have to bring to them in their inert,
          anonymous condition a personal love.”
        </p>
      </>
    )
  },
  ...
  '2021-02-28': {
    ...
    content: (
      <p>
        ...
        development in the church. Nor should it be too quickly handled as any
  ...
  '2021-06-06': {
    subTitle: (
      <>
        From <i> Freedom of Simplicity </i> by Richard J. Foster
      </>
    ),
    content: (
      <>
        <p>
          ...
          preaching the Gospel at all.” Given the contemporary milieu, several
          dimensions of simplicity seem to me to need careful attention in the
          teaching ministry of the church.
        </p>
        <p>
          We must boldly teach the essential connection between the inner and
          outer aspects of simplicity. We can no longer allow people to engage
          in pious exercises that are divorced from the hard social realities of
          life. Nor can we tolerate a radical social witness that is devoid of
          inward spiritual vitality. Our preaching and teaching needs to hold
          these elements in unity. If our teaching is centered in the biblical
          text, we will find literally hundreds of examples – from Abraham to
          St. John, from the wisdom literature to the apocalyptic writings.”
        </p>
      </>
    )
  },
  ...
  '2021-11-21': {
    ...
    content: (
      <>
        <p>
          “And so when we had a decision to make, we would open the Gospel at
          random, after having said a little prayer, and then we did whatever
          was written, without adding anything.
        </p>
        <p>
          This manner of action gave us a boundless liberty, and nurtured
          simplicity of heart with some solid food.
        </p>
        <p>
          Another important element taking shape in the community we were
          forming was the primacy of faith instead of structures.
        </p>
        <p>
          We felt ourselves to be a community in search of God, not a seminary
          for the priesthood.
        </p>
        <p>
          What made us one was Christ, and the imitation of him gave meaning to
          the manner of living of each one of us.
        </p>
        <p>
  ...
  '2022-04-24': {
    ...
    content: (
      <p>
        “All spiritual disciplines are to help you trust this personal
